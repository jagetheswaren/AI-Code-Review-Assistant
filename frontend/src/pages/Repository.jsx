  ...
  return (
    <div className="min-h-screen bg-[#0F172A] p-6 lg:p-8">
      ...
      <motion.div variants={fadeUp} initial="hidden" animate="visible" transition={{delay:0.2}}>
        ...
        : <EmptyState icon={GitPullRequest} title={prSearch?"No matching PRs":"No pull requests found"} description={prSearch?"Try different search term":"This repository has no pull requests or they could not be loaded."} />}
      </motion.div>
    </div>
  );
}
